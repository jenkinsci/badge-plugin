...
Version 3.0 removes legacy features introduced in <<Version 2.x>> and therefore breaks compatibility in case the legacy features where not migrated before upgrading the plugin. More details on this can be found in the https://github.com/jenkinsci/badge-plugin/releases/tag/3.583.vdc8d4a_a_1d586[Release Notes for 3.583.vdc8d4a_a_1d586].
